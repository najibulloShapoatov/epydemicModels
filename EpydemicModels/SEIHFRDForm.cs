...
{
    public partial class SEIHFRDForm : Form
    {
        public SEIHFRDForm()
        {
            InitializeComponent();
            string startupPath = Environment.CurrentDirectory;
            webBrowser1.Navigate(startupPath + "\\data\\SEIHFRD.pdf");
        }

        private void SEIHFRDForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            model.delta2 = Utils.toDoble(delta_1_.Text);
            model.k = Utils.toDoble(k_.Text);
